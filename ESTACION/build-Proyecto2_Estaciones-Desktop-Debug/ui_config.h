...
public:
    ...
    {
        Config->setWindowTitle(QApplication::translate("Config", "Configuraci\303\263n", Q_NULLPTR));
        label_msg->setText(QString());
        label->setText(QApplication::translate("Config", "Ingrese el c\303\263digo de la estaci\303\263n en la que se encuentra:", Q_NULLPTR));
        pushButton->setText(QApplication::translate("Config", "Aceptar", Q_NULLPTR));
    } // retranslateUi
